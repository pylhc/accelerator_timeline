# -*- coding: utf-8 -*-
#
# accelerator_timeline documentation build configuration file, created by
...
htmlhelp_basename = 'accelerator_timelinedoc'
...
latex_documents = [
    (master_doc, 'accelerator_timeline.tex', u'accelerator_timeline Documentation',
     u'OMC-TEAM', 'manual'),
]
...
man_pages = [
    (master_doc, 'accelerator_timeline', u'accelerator_timeline Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'accelerator_timeline', u'accelerator_timeline Documentation',
     author, 'accelerator_timeline', 'One line description of project.',
     'Miscellaneous'),
]
...
sphinx_gallery_conf = {
     ...
     'filename_pattern': '/interactive',
     'ignore_pattern': r'.+(export.+|utilities/.+|doc/.+|__init__)\.py',
